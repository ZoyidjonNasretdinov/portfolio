...
const Contact = () => {
  const contacts = [
    {
      icon: <MdOutlineEmail className="text-[1vw] tablet:text-[1.5vw] mobile:text-[6vw] mobile:rounded-[2vw]" />,
      title: "Email Me",
      url: "email:zoyidjonnasretdinovcoder@gmail.com",
    },
    {
      icon: <RiCalendarScheduleLine className="text-[1vw] tablet:text-[1.5vw] mobile:text-[6vw] mobile:rounded-[2vw]" />,
  ...
  return (
    <section className="bg-primary w-full rounded-[0.8vw] mobile:rounded-[4vw] px-[1.5vw] py-[2vh] text-white shadow-lg
      h-auto tablet:px-[3vw] mobile:px-[4vw] mobile:py-[4vh]">
      
      {/* Header */}
      <div className="mb-[1vh] text-center">
        <span className="flex p-[0.8vw] w-[3vw] h-[3vw] tablet:w-[6vw] mobile:w-[20vw] mobile:h-[20vw]
          items-center justify-center mx-auto mb-[1.5vh] bg-secondary rounded-full">
          <GiImperialCrown
            className="text-[2.8vw] tablet:text-[2vw] mobile:text-[14vw] text-textSecondary"
          />
        </span>
        <h2 className="text-[0.9vw] font-bold tablet:text-[2vw] mobile:text-[4vw]">
          Let’s Work Together
        </h2>
        <p className="text-[0.8vw] text-textPrimary tablet:text-[5.5vw] mobile:text-[5vw]">
          ...
          >
            ...
            >
              <div className="flex items-center gap-[0.5vw] mobile:gap-[5vw]">
                <span className="flex items-center justify-center p-[0.4vw] bg-[#282828] rounded-[0.4vw] mobile:p-[2vw] mobile:text-[6vw]">
                  {contact.icon}
                </span>
                <span className="text-[0.8vw] tablet:text-[1.2vw] mobile:text-[5vw]">
                  {contact.title}
                </span>
              </div>
