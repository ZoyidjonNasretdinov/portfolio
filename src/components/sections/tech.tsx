...
const TechStacks = () => {
  return (
    <section className="bg-primary w-full h-[34vh] rounded-[1vw] mobile:rounded-[4vw] px-[0.8vw] py-[2vh] text-textPrimary shadow-lg mobile:p-[4vw] relative">
      {/* Header */}
      <div className="mb-[2vh] text-center">
        <h2 className="flex gap-[0.5vw] text-[0.8vw]  justify-center items-center font-medium mobile:text-[4vw]">
          <GoStack className="text-textSecondary text-[1.2vw] mobile:text-[5vw]" /> My Stacks
        </h2>
        <p className="text-[1.6vw] font-bold mobile:text-[6vw]">Tech Arsenal</p>
      </div>
      ...
      <ol className="grid grid-cols-2 gap-[0.7vw] mobile:gap-[3vw] justify-center">
        {[
          ...
          <li
            key={index}
            className="relative flex items-center justify-between gap-[0.5vw] w-full h-[8vh] px-[0.8vw] mobile:px-[2.5vw] py-[1vh] bg-secondary rounded-[0.8vw] mobile:rounded-[2vw]
          ...
          >
            ...
            <div className="flex items-center gap-[0.5vw] mobile:gap-[1.2vw] whitespace-nowrap overflow-hidden text-ellipsis">
              <span className="flex items-center justify-center p-[0.5vw] mobile:p-[1.5vw] bg-[#282828] rounded-[0.5vw] mobile:rounded-[3vw]">
                {React.cloneElement(tech.icon, {
                  className: 'text-textSecondary mobile:text-[6vw]',
                })}
              </span>
              <span className="text-[0.8vw] font-medium mobile:text-[3.2vw]">{tech.title}</span>
            </div>
            ...
            <span className="text-[1vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-x-1">
              <MdOutlineArrowOutward className="text-textSecondary mobile:text-[4.5vw]" />
            </span>
          </li>
        ))}
      </ol>
